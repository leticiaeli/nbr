...
df$Tipo1[df$Tipo == "frio"] = 'T \u2264 18 °C'
df$Tipo1[df$Tipo == "calor"] = 'T \u2265 26°C (28)°C'
df$Tipo1[df$Tipo == "conf"] = '18°C < T < 26°C (28)°C'
...
df$Tipo1 = factor(df$Tipo1, levels=c("T \u2265 26°C (28)°C", "T \u2264 18 °C", "18°C < T < 26°C (28)°C"))
